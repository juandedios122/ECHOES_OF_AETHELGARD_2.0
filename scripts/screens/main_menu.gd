...
@onready var btn_play     : TextureButton = $VBoxContainer/ButtonPlay
@onready var btn_gacha    : TextureButton = $VBoxContainer/ButtonGacha
@onready var btn_settings : TextureButton = $VBoxContainer/ButtonSettings
